...
def analyzer(request):
    ...
    try:
        ...
        AuditDetails.objects.create(
            ...
            h4_count=result["paragraphes"]["h4_count"],
            h5_count=result["paragraphes"]["h5_count"],
            h6_count=result["paragraphes"]["h6_count"],
            ...
            meta_seo_score=result["meta_seo_score"],
            images_seo_score=result["images_seo_score"],
            links_seo_score=result["links_seo_score"],
